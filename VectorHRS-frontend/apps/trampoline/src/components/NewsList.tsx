import { Flex,Image,Badge, Heading, Box } from "@chakra-ui/react"
    ...
    return <>
                ...
                <Link to={link} >
                    ...
                    <Flex w='100%' p={4} color='white' alignItems='center' position={"relative"} borderBottom={"thin solid var(--borderColor)"}>
                        ...
                        <Heading as='h3' size='sm' noOfLines={1} display="block" width={"100%"}>
                            {props.name ? props.name : ""}
                        </Heading>
                            <Box color={"var( --black)"} paddingLeft="2rem" paddingRight="2rem">
