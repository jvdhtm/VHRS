...
export var annotateResource = function (resourceKey, annotations) {
            ...
            if (Object.prototype.hasOwnProperty.call(annotations.fields, fieldName)) {
                ...
                if (field === null || field === void 0 ? void 0 : field.display) {
                    ...
                    if (existingFields && typeof tempField !== "undefined") {
                        ...
                        tempField.display = __assign(__assign({}, oldDisplay), { components: __assign({}, componentsWithContext), ctx: ctx || { resource: resource, props: {} }, access: access, partOf: partOf });
    ...
    if (annotations.display) {
        ...
        var componentsWithContext = addContext(components, resource);
        resource.display = __assign(__assign({}, resource.display), { components: __assign({}, componentsWithContext), ctx: ctx || { resource: resource, props: {} }, access: access, partOf: partOf });
    }
