...
var QuestionProvider = function (_a) {
    ...
    var questionList = function (data) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var result, prevStateResults_1, logActions, found_1, newCount, newNext, newPrevious, newQuestion, newQuestionserializedById_1;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    newQuestionserializedById_1 = [];
                    newQuestion.map(function (el) {
                        if (el.id) {
                            newQuestionserializedById_1[el.id] = el;
                        }
                    });
                    setQuestionDataList({
                        count: newCount,
                        ...
                        results: newQuestionserializedById_1,
                    });
                    setLoading(false);
                    _a.label = 2;
    ...
    var questionRead = function (id) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var result_1, prevStateResults, logActions, found_2, newQuestion, newQuestionserializedById_2;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    if (!found_2) {
                        newQuestion.push(result_1.data);
                    }
                    newQuestionserializedById_2 = [];
                    newQuestion.map(function (el) {
                        if (el.id) {
                            newQuestionserializedById_2[el.id] = el;
                        }
                    });
                    setQuestionDataList(tslib_1.__assign(tslib_1.__assign({}, QuestionDataList), { results: newQuestionserializedById_2 }));
                    setLoading(false);
                    _a.label = 2;
                case 2: return [2 /*return*/];
            }
    ...
    var questionUpdate = function (id, data) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var result_2, prevStateResults, logActions, newQuestion, newQuestionserializedById_3;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    newQuestionserializedById_3 = [];
                    newQuestion.map(function (el) {
                        if (el.id) {
                            newQuestionserializedById_3[el.id] = el;
                        }
                    });
                    setQuestionDataList(tslib_1.__assign(tslib_1.__assign({}, QuestionDataList), { results: newQuestionserializedById_3 }));
                    setLoading(false);
                    _a.label = 2;
                case 2: return [2 /*return*/];
            }
    ...
    var questionPartial = function (id, data) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var result_3, prevStateResults, logActions, newQuestion, newQuestionserializedById_4;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(id && data)) return [3 /*break*/, 2];
                ...
                case 1:
                    ...
                    newQuestionserializedById_4 = [];
                    newQuestion.map(function (el) {
                        if (el.id) {
                            newQuestionserializedById_4[el.id] = el;
                        }
                    });
                    setQuestionDataList(tslib_1.__assign(tslib_1.__assign({}, QuestionDataList), { results: newQuestionserializedById_4 }));
                    setLoading(false);
                    _a.label = 2;
                case 2: return [2 /*return*/];
            }
    ...
    var questionDelete = function (id) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var result, prevStateResults, logActions, newQuestion, newQuestionserializedById_5;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!id) return [3 /*break*/, 2];
                ...
                case 1:
                    ...
                    newQuestionserializedById_5 = [];
                    newQuestion.map(function (el) {
                        if (el.id) {
                            newQuestionserializedById_5[el.id] = el;
                        }
                    });
                    setQuestionDataList(tslib_1.__assign(tslib_1.__assign({}, QuestionDataList), { results: newQuestionserializedById_5 }));
                    setLoading(false);
                    _a.label = 2;
                case 2: return [2 /*return*/];
            }
