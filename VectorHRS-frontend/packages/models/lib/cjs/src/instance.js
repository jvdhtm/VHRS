...
exports.dataLayerObj = exports.ResourceInternalCache = exports.instance = void 0;
var tslib_1 = require("tslib");
var axios_1 = tslib_1.__importDefault(require("axios"));
var hash_1 = tslib_1.__importStar(require("./hash"));
    ...
    function ResourceInternalCache() {
        ...
        this.get = function (resource, id) {
            ...
            if (id) {
                ...
                var tempid = (0, hash_1.hid)(resource);
...
exports.ResourceInternalCache = ResourceInternalCache;
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.dedupRequest((0, hash_1.default)([Request.endpoint, headers]), function () {
